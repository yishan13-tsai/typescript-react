...
const OrderInfoCard = () => {
  return (
    <Card className="p-10">
      ...
      <p className="title-line before:border-neutral-60">退房：6 月 11 日星期三，12:00 前退房</p>
      <Divider />
      {/* 溝溝component */}
    </Card>
  )
        ...
        <div className="p-4 md:max-w-[1296px] mx-auto grid grid-cols-12 md:gap-x-[72px]">
          ...
          <div className="gap-4 col-span-12 md:col-span-7 text-neutral-0 ">
            <div className="flex items-center">
              <img src={SuccessIcon} alt="success" className="row-span-3 mr-10 w-10 h-10 content-center" />
              <div className="text-4xl leading-heading font-bold">
                <p className="my-0">恭喜，Jessica！</p>
                <p className="my-0">您已預訂成功</p>
              </div>
            </div>
            <p className="font-normal">我們已發送訂房資訊及詳細內容至你的電子信箱，入住時需向櫃檯人員出示訂房人證件。</p>
