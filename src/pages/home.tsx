    ...
    <>
      <div className="">
                ...
                <div className="main_block absolute top-1/2 right-[9.5%] -translate-y-1/2">
                  <div className="main_title text-neutral-0">
                    <div>
                      ...
                      <h1 className="m-0 text-[6.25rem] font-bold">
                        豪華住宿之選
                      </h1>
                    </div>
                    <p className="m-0 text-[2rem] font-semibold mb-[60px]">
        ...
        <section className="news w-[70%] mx-auto my-[120px] px-4 bg-primary-10 relative">
          <img
            className="absolute right-[-80px] top-[20px] w-[12%] bg-cover"
                ...
                return (
                  <div className="flex flex-wrap mb-10">
                    ...
                    <div className="-mx-4 w-7/12 flex-none px-4 grid content-center">
                      ...
                      <p className="font-medium text-base text-neutral-80">
                        {item.description}
                      </p>
                    </div>
                  </div>
          ...
          <img
            className="absolute left-[-80px] bottom-[-180px] z-10 w-[12%] bg-cover"
            src="./home_page/dot.png"
            alt=""
          />
        </section>
        <section className="about w-full bg-neutral-120 relative">
          <div>
            ...
            />
            <div
              className="container h-[672px] w-2/3 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
        ...
        <section className="rooms bg-neutral-120 pb-[120px] relative">
          <img
            className="absolute right-[5px] top-[100px] w-[52%] bg-cover"
